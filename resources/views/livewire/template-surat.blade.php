<div>
      ...
      <form action="{{ route('cetak-pdf') }}" target="_blank" method="post">
        ...
        <div class="input-group mb-3">
          ...
          <select wire:model="template" class="form-select" id="templateSurat">
            ...
            <option>Surat Keterangan Untuk Menikah</option>
            <option>Surat Promosi Jabatan</option>
          </select>
        </div>
      </form>
    </div>
  ...
  {{-- <div class="card"> --}}
  <div class="card {{ $template != 'Surat Promosi Jabatan' ? 'd-none' : '' }}">
    <div class="card-body">
      <h4 class="card-title">Surat Promosi Jabatan</h4>
      <form class="row g-3" action="{{ route('cetak-surat','surat-promosi-jabatan') }}" target="_blank" method="post">
        @csrf
        ...
        <div class="col-md-6">
          <label for="tmt" class="form-label">TMT Golongan</label>
        ...
        <div class="col-md-6">
          ...
          <input type="number" class="form-control" name="nip_camat" id="nip_camat">
        </div>
